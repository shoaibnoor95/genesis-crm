...
class CallBack extends Component {
    ...
    updateDeal() {
        ...
        console.log("Testing==>>", this.state.data[this.state.modalIndex].status.status)
        ...
        if (cc === " " && this.state.data[this.state.modalIndex].cardDetail === "") {
            let deal = {
                ...
                status: {
                    status: ssn === " " ? this.state.data[this.state.modalIndex].status.status : this.state.oldSSNList.indexOf(ssn) !== - 1 || this.state.oldPhoneList.indexOf(phone) !== -1 ? "Dublicated" : this.state.data[this.state.modalIndex].status.status,
            ...
            console.log("Testing==>>", this.state.oldSSNList.indexOf(ssn) !== - 1 || this.state.oldCardList.indexOf(this.state.data[this.state.modalIndex].cardDetail[cardIndex].cc) !== -1 || this.state.oldPhoneList.indexOf(phone) !== -1 ? "Dublicated" : this.state.data[this.state.modalIndex].status.status)
            ...
            let deal = {
                ...
                CloserNotes: this.state.data[this.state.modalIndex].CloserNotes === undefined ? "" : this.state.data[this.state.modalIndex].CloserNotes,
                status: {
                    status: ssn === " " ? this.state.data[this.state.modalIndex].status.status : this.state.oldSSNList.indexOf(ssn) !== - 1 || this.state.oldCardList.indexOf(this.state.data[this.state.modalIndex].cardDetail[cardIndex].cc) !== -1 || this.state.oldPhoneList.indexOf(phone) !== -1 ? "Dublicated" : this.state.data[this.state.modalIndex].status.status,
                    callbackDate: this.state.data[this.state.modalIndex].status.callbackDate,
                    callbackTime: this.state.data[this.state.modalIndex].status.callbackTime,
                    transferCloserID: this.state.data[this.state.modalIndex].status.transferCloserID,
                    transferCloserName: this.state.data[this.state.modalIndex].status.transferCloserName,
    ...
    //                 if (data.val()[uid][key].status.status === "Call Back") {
    ...
    saleTransfer(closer, i) {
        // {Authorization: "key=AAAAYDEKolI:APA91bGbHVcLDF2DpJL3EE5u5RnyzQrfF6DI6g5vrNFtjRXzHdYbBTDxhwOU2JsHk6QsNJtbRYh6jDdRpxsHuOd-af85R3bhAQHKu1MJW5rSib-0WlyuloZONXe7IkNnF3otJPain1Rw"}
        ...
        //     },
        //     "to": "fGpyZGZHX8E:APA91bHBkhorvPCtKgIL33cjwWqieLEtSZc5qjpKwOVIJC26ERbvG4fqP6CVJfr-jB5D1eaPoYT2m3x63Tj2wnmOFSQ7R56Z64dem8N0IWFHsAPaU3rXyRfrE9ruSgOVTwdGmPDpIxVk"
        // }
                                                ...
                                                <tr key={i}>
                                                    ...
                                                    <td>
                                                        {v.status.status === "Dublicated" ?
                                                            ...
                                                            :
                                                            <Button size="sm" color={v.status.status === "Transfer" ? 'outline-dark' : 'outline-primary'} onClick={this.showModal.bind(this, i)} disabled={v.status.status === "Transfer" ? true : v.status.status === "Dublicated" ? true : false}><i className={v.status.status === "Transfer" ? "fa fa-exclamation-circle" : "fa fa-search"}></i> {v.status.status === "Transfer" ? "Disabled" : "View"}</Button>
                                                        }
                                                    </td>
                                                    {v.status.status === "Transfer" ?
                                                        <td><Button title={"To " + v.status.transferCloserName} size="sm" color={'outline-dark'} disabled><i className="fa fa-check"></i> Transferred</Button></td>
                                                        :
                                                        v.status.status === "Dublicated" ?
                                                            <td><Button title={"Dublicated"} size="sm" color={'outline-dark'} disabled><i className="fa fa-exclamation-circle"></i> Disabled</Button></td>
                                                            :
                                                            <td>
                                                                <Button size="sm" color={'outline-success'} disabled={v.status.status === "Dublicated" ? true : false} onClick={this.transferModalOpen.bind(this, i)}><i className="fa fa-exchange"></i> Transfer</Button>
                                                                            ...
                                                                            <Col xs="12">
                                                                                <Col xs="12">
                                                                                    <FormGroup>
                                                                                        ...
                                                                                        <NumberFormat style={{ backgroundColor: "#e4e7ea" }} disabled displayType={'input'} className="format" format="################" id="cc" placeholder="Credit Card Number" value={cc === " " ? this.state.data[this.state.modalIndex].cardDetail[this.state.cardIndex].cc : cc} />
                                                                                        {this.state.ccError === "" ?
                                                                                            null
                                                                                            :
                                                                                ...
                                                                                <Col xs="12">
                                                                                    <FormGroup>
                                                                                        ...
                                                                                        <Input disabled type="text" id="nameOnCard" placeholder="Name On Card" value={nameOnCard === " " ? this.state.data[this.state.modalIndex].cardDetail[this.state.cardIndex].nameOnCard : nameOnCard} />
                                                                                    </FormGroup>
                                                                                </Col>
                                                                                <Col xs="12">
                                                                                    <FormGroup row className="my-0">
                                                                                        <Col xs="6">
                                                                                            <FormGroup>
                                                                                                ...
                                                                                                <NumberFormat style={{ backgroundColor: "#e4e7ea" }} disabled displayType={'input'} className="format" id="cvc" format={this.state.cardScheme === "amex" ? "####" : "###"} placeholder="Customer Verification Code" value={cvc === " " ? this.state.data[this.state.modalIndex].cardDetail[this.state.cardIndex].cvc : cvc} />
                                                                                            </FormGroup>
                                                                                        </Col>
                                                                                        <Col xs="6">
                                                                                            <FormGroup>
                                                                                                <Label htmlFor="country">Exp#</Label>
                                                                                                <NumberFormat style={{ backgroundColor: "#e4e7ea" }} disabled format={this.cardExpiry} className="format" id="exp" placeholder="CC Expiration" value={exp === " " ? this.state.data[this.state.modalIndex].cardDetail[this.state.cardIndex].exp : exp} />
                                                                                            </FormGroup>
                                                                                        </Col>
                                                                                    </FormGroup>
                                                                                </Col>
